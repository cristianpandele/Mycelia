...
void Mycelia::processBlock(juce::AudioBuffer<float> &buffer,
...
//==============================================================================
bool Mycelia::hasEditor() const
{
    return true; // (change this to false if you choose to not supply an editor)
}

juce::AudioProcessorEditor *Mycelia::createEditor()
{
    return new MyceliaEditor(*this);
}
